...
def spatial_average(in_tens, keepdim:bool=True):
...
class LPIPS(nn.Module):
    ...
    def forward(self, in0, in1, normalize:bool=False):
        ...
        diffs = [(lpips.normalize_tensor(outs0[kk]) - lpips.normalize_tensor(outs1[kk])) ** 2 for kk in range(self.L)]

        res = [
            spatial_average(self.lins[0](diffs[0]), keepdim=True),
            spatial_average(self.lins[1](diffs[1]), keepdim=True),
            spatial_average(self.lins[2](diffs[2]), keepdim=True),
            spatial_average(self.lins[3](diffs[3]), keepdim=True),
